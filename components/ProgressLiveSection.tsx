      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          <div style={{
            ...
            {/* Filter kecamatan → lihat per desa (di atas detail) */}
            ...
            >
              ...
              {kecOptions.map(o => (
                <option key={o.kdkec} value={o.kdkec}>{o.nmkec} — per desa</option>
              ))}
            </select>
            ...
            {selected ? (
              ...
              <p style={{ fontSize: 13, color: '#8C7B6B', lineHeight: 1.6, margin: 0 }}>
                Klik salah satu kecamatan di peta untuk melihat detail realisasi pencacahan.
              </p>
            )}
